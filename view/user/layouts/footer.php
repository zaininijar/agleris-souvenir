...
<footer style="padding: 80px 80px 30px 80px;">
    ...
    <p style="margin-top: 30px; border-top: 1px solid #acacac; padding-top: 30px;">Copyright 2023 © Web Souvenir</p>
</footer>
<a href="<?= $base_url . 'souvenir/shopping-chart' ?>" class="buble-chart">
    <div class="count"><?php print(isset($new_chart_count)) ? $new_chart_count : $chart_count; ?></div>
